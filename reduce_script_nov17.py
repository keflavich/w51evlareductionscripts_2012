...
Dec 09
"""
# nov 17: 12B-365_sb11988384_1
vis = '12B-365.sb11988384.eb13946573.56248.74433101852.ms' # Nov 17
rootvis = vis
rootprefix = prefix = vis.replace(".ms","")
rootprefix = prefix = 'w51_nov17'
...
import cal_script
for spwn in [  '7', '8', '9', '10', '11', '12', '13', '14', '15', '0', '1', '2','3','4','5',  ]: #'6',
